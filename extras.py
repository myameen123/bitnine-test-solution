...
email: yameenmuhamamd960@gmail.com

My modifued code start when  "NamedTupleCursor" class ends
from line 407 onwards
'''
...
##########################        MODIFIED CODE        ################################
'''
This is the modfication in orginal driver code to return data in json formate
'''
